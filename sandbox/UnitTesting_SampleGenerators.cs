...
{
    private T NonNullableT => throw new NotImplementedException();
    private T? NullableT => throw new NotImplementedException();
    ...
    internal string? InternalNullableStringReturningMethod(ref T value)
    {
        throw new NotImplementedException();
    }

    protected string? ProtectedNullableTParameterMethod(out T? value)
    {
        throw new NotImplementedException();
    }

    [FGDebug]
    private sealed partial class Nested
    {
        [FGDebug]
        private class OneAnother
        {
        }
    }
    ...
    private interface __INestedInterface__<in A, out B> where A : B, IDisposable, new(), allows ref struct
    {
    }
