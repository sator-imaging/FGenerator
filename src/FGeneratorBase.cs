...
";
        ...
        private bool IsSyntaxTargetForGeneration(SyntaxNode node)
        {
            ...
            SyntaxList<AttributeListSyntax> attributeLists = node switch
            {
                ...
                VariableDeclaratorSyntax v when v.Parent is VariableDeclarationSyntax vd && vd.Parent is BaseFieldDeclarationSyntax bf => bf.AttributeLists,
                ...
                CompilationUnitSyntax cu => cu.AttributeLists,        // assembly/module-level attributes. [module: Discover] Won't support
                _ => default
            };
        ...
        private Target? GetSemanticTargetForGeneration(GeneratorSyntaxContext context)
        {
            ...
            {
                // TODO: There is no way to emit diagnostic on return type of method symbol. [return: Discover]
