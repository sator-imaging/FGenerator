...
namespace FinalEnumGenerator.Test;

// Unity compatibility
[AttributeUsage(AttributeTargets.All, Inherited = false)]
internal sealed class InspectorNameAttribute(string ___) : Attribute
{
    public readonly string not_used = ___;
}
...
public enum MyTestFlagsType
{
    ...
    [Category("ひらがな \"français\" カタカナ")] Flag3 = 4,
    Flag4 = 8,

    [Category("Display Name")] Flag5 = 16,
